...
- Safety property, velocity-api `3.2.0-SNAPSHOT` pin, profile scope, `eventOrderTest`: `velocity/CLAUDE.md`.
...
- Via reflective accessors, Paper vs Spigot path, `Throwable` containment, NMS diagnostics: `spigot/CLAUDE.md`.
