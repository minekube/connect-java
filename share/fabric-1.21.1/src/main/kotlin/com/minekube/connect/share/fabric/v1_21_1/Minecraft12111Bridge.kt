...
class Minecraft1211Bridge internal constructor(
    transport: Minecraft1211Transport,
...
internal class GatewayMinecraft1211Bridge(
    gateway: ShareConnectionGateway,
    loginAdmissionFactory: () -> FabricLocalLoginAdmissionGate,
) : VersionedMinecraftBridge(
    transport = VanillaMinecraft1211Transport(),
    gateway = gateway,
...
internal typealias Minecraft1211Transport = MinecraftVersionTransport
