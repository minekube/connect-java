...
class FabricConnectShare1211Client : ClientModInitializer {
    override fun onInitializeClient() {
        ConnectShare1211Runtime(FabricPlatform).initialize()
    }

    private object FabricPlatform : ConnectShare1211Platform {
