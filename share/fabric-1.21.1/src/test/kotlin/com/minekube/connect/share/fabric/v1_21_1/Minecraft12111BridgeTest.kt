...
class Minecraft1211BridgeTest {
    ...
    fun `failed local bind rolls back the private vanilla listener`() = runBlocking {
        val transport = FakeMinecraftTransport()
        val bridge = Minecraft1211Bridge(
            transport,
    ...
    private class FakeMinecraftTransport : Minecraft1211Transport {
        var publishedPort = -1
        var listenerCount = 0
