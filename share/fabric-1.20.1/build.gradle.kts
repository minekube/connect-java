...
base {
    archivesName = "connect-share-fabric-1.20.1"
}
...
dependencies {
    ...
    modImplementation("net.fabricmc.fabric-api:fabric-api:${Versions.fabricApi1201Version}")
...
val connectShareShadowJar = tasks.named<ShadowJar>("shadowJar") {
    ...
    archiveBaseName.set("connect-share-fabric-1.20.1")
