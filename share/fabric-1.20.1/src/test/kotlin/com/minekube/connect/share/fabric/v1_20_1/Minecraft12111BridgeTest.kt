...
class Minecraft1201BridgeTest {
    ...
    fun `failed local bind rolls back the private vanilla listener`() = runBlocking {
        val transport = FakeMinecraftTransport()
        val bridge = Minecraft1201Bridge(
            transport,
    ...
    private class FakeMinecraftTransport : Minecraft1201Transport {
        var publishedPort = -1
        var listenerCount = 0
