    ...
    private fun buildConnectionOptions() {
        ...
        offlineMode = addRenderableWidget(
            ObservableCheckbox(
                ...
                offlineSelected,
            ) { selected -> offlineSelected = selected }.apply {
                setTooltip(
                    Tooltip.create(
                        Component.translatable("connect_share.join.offline.tooltip"),
                    ),
                )
            },
        )
        internetDirect = addRenderableWidget(
            ObservableCheckbox(
                ...
                internetSelected,
            ) { selected -> internetSelected = selected }.apply {
                setTooltip(
                    Tooltip.create(
                        Component.translatable("connect_share.join.internet.tooltip"),
                    ),
                )
            },
        )
