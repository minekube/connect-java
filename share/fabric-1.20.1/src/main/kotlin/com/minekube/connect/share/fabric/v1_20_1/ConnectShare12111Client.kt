...
class ConnectShare1201Runtime(
    private val platform: ConnectShare1201Platform,
) {
    fun initialize() {
            ...
            try {
                val installation = FabricShareBootstrap.create(
                    ...
                    bridgeFactory = {
                            ...
                            gateway,
                        ->
                        GatewayMinecraft1201Bridge(gateway) {
        ...
        val admissionToastId = SystemToast.SystemToastIds.PERIODIC_NOTIFICATION
    ...
    private fun connectFollow(
        ...
        ConnectScreen.startConnecting(
            ...
            minecraft,
            address,
            ServerData(action.displayName, address.toString(), false),
            false,
        )
    }
...
interface ConnectShare1201Platform {
